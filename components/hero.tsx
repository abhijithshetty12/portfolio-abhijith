...
export const Hero = () => {
  return (
    <div className="relative flex flex-col min-h-screen h-full w-full pb-20 sm:pb-28 md:pb-36 lg:pb-44">
      <video
        autoPlay
        muted
        loop
        playsInline
        className="rotate-180 absolute top-[-360px] left-0 w-full h-full object-cover opacity-80 brightness-110 -z-20"
      >
      ...
      >
        <div className="flex flex-col gap-6 justify-center text-center md:text-start w-full md:w-[58%] z-30">
          <motion.div
            ...
            className="mx-auto md:mx-0 bg-purple-950/20 border border-purple-500/30 backdrop-blur-md px-4 py-1.5 rounded-full flex items-center w-fit shadow-[0_4px_24px_rgba(168,85,247,0.15),inset_0_1px_1px_rgba(168,85,247,0.2)] hover:border-purple-400/50 transition-colors duration-300 group"
          >
          ...
          >
            {TECH_STACK.map((tech, i) => (
              <motion.div
                ...
                className="flex items-center gap-2.5 px-4 py-1.5 rounded-xl bg-white/[0.01] border border-white/[0.06] backdrop-blur-md shadow-[0_4px_20px_rgba(0,0,0,0.4)] hover:bg-purple-950/20 hover:border-purple-500/30 hover:shadow-[0_0_15px_rgba(168,85,247,0.15)] transition-all duration-300 group"
              >
