    ...
    <div className="relative flex flex-col h-full w-full">
      ...
      >
        ...
        >
          <Link 
            href="/projects" 
            className="text-center py-3 sm:py-2.5 px-6 rounded-full text-xs font-semibold tracking-wider text-slate-950 bg-gradient-to-r from-cyan-400 via-teal-300 to-cyan-400 bg-[length:200%_auto] hover:bg-right shadow-[0_0_20px_rgba(34,211,238,0.2)] hover:shadow-[0_0_35px_rgba(34,211,238,0.45)] transition-all duration-500 active:scale-95"
          >
            View Projects
          </Link>
